              ...
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm text-gray-900">
                    {#if hit.quizes}{hit.quizes.length}{:else}Geen quizjes
                      gevonden{/if}
                  </div>
                </td>
                <td
                ...
                >
                  <a
                    href="/beheer/activiteit/{hit.objectID}"
                    class="text-indigo-600 hover:text-indigo-900">Bekijken</a
                  >
                  <a
                    href="/beheer/activiteit/{hit.objectID}/wijzigen"
                    class="text-indigo-600 hover:text-indigo-900">Wijzigen</a
                  >
                  <a
                    href="/beheer/activiteit/{hit.objectID}/dashboard"
