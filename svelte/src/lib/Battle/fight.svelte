<script>
 // import firebase from "firebase/app";
  ...
  function checkCorrectAnswer(quiz) {
    let score = -1;
    if (quiz.selectedAnswer !== null && quiz.answers[quiz.selectedAnswer].correct === true) {
      quiz.correct = true;
              ...
              >
                <div class="absolute inset-0">
                  {#if quiz.correct == true}
                    <div class="text-5xl">Enemy defeated!</div>
                    <svg
