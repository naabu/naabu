...
<div>
    <div>
      <nav class="sm:hidden" aria-label="Back">
        <a href="/beheer/leerdoel" class="flex items-center text-sm font-medium text-gray-400 hover:text-gray-200">
          ...
          <li>
            <div>
              <a href="#" class="text-gray-400 hover:text-gray-500">
                <a href="/beheer" class="text-sm font-medium text-gray-400 hover:text-gray-200">Beheer</a>
              </a>
            </div>
          </li>
          <li>
            <div class="flex items-center">
              ...
              <a href="/beheer/leerdoel" class="ml-4 text-sm font-medium text-gray-400 hover:text-gray-200">Leerdoel</a>
            </div>
          </li>
          <li>
            <div class="flex items-center">
              ...
              <a href="#" aria-current="page" class="ml-4 text-sm font-medium text-gray-400 hover:text-gray-200">Leerdoel maken</a>
            </div>
          </li>
        </ol>
      </nav>
