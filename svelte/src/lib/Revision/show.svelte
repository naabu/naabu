  ...
  <div class="flex">
    ...
    <div class="ml-3">
      ...
      <div class="mt-2 text-sm text-yellow-700">
        ...
        <p>
          <a class="underline" href="/leerdoel/{revision.goalId}">hoofdpagina</a
          >
        </p>
        ...
        <p>
          {#if previousRevision !== null}
            ...
            <a class="underline" href="/revisie/{revision.id}">Huidige versie</a
            >
            <a
              class="underline"
              href="/revisie/{revision.id}/diff/{previousRevision.id}">Wijz</a
            >
          {/if}
